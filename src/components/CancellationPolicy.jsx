...
const CancellationPolicy = () => {
  ...
  const sections = [
    ...
    { id: 'exceptions', title: 'Non-Cancellable Items' },
    { id: 'process', title: 'Cancellation Process' },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Review our Cancellation & Refund Policy for purchases made at Chinju Store." />
      </Helmet>
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md">
              ...
              <section id="interpretation" className="mb-10">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700">
                    Capitalized terms have meanings defined under the following conditions. The following definitions apply regardless of whether they appear in singular or plural.
                  </p>
                </div>
                
                <div>
                  <h3 className="text-xl font-semibold mb-3 text-gray-700">Definitions</h3>
                  <p className="text-gray-700 mb-4">For the purposes of this Cancellation Policy:</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-700">(referred to as "we", "us", or "our") refers to the individual business entity operating at <a href="https://chinjustore.in/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline">https://chinjustore.in/</a>.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="text-gray-700">means the individual placing an order through our Service.</p>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="exceptions" className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-800 border-b pb-2">Non-Cancellable Items</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      We reserve the right to refuse cancellation requests if:
                    </p>
                    <ul className="list-disc pl-5 space-y-2 mt-2 text-gray-700">
                      <li>The order has already been shipped</li>
                      <li>Fraudulent activity is suspected</li>
                      <li>Multiple cancellation requests are made for the same product</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section id="process" className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-800 border-b pb-2">Cancellation Process</h2>
                
                <div className="space-y-6">
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-gray-700">Step-by-Step Guide</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-gray-700">After Cancellation</h3>
                    <p className="text-gray-700">
                      Once your cancellation is confirmed:
                    </p>
                    <ul className="list-disc pl-5 space-y-2 mt-2 text-gray-700">
                      <li>You will receive an email confirmation of cancellation</li>
                      <li>Your refund process will begin automatically</li>
                      <li>The refund amount will reflect in your account within 7-10 business days</li>
                      <li>Order status will be updated to "Cancelled" in your account</li>
                    </ul>
                  </div>
                </div>
              </section>
