            ...
            <div className="p-4 border-b border-gray-200">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center border border-gray-300 rounded-md text-sm text-gray-700 focus:outline-none">
                    <FiFilter size={16} className="ml-2 text-gray-500" />
                    <select
                      value={statusFilter}
                      onChange={(e) => {
                      ...
                      className="px-2 py-2 rounded-r-md text-sm bg-white border-none focus:outline-none"
                    >
                      <option value="all">All Statuses</option>
                      <option value="pending">Order Pending</option>
                      <option value="accept">Order Accept</option>
                      <option value="reject">Order Reject</option>
                      <option value="departed">Delivery Departed</option>
                      <option value="pendingDelivery">Delivery Pending</option>
                      <option value="project">Delivery Project</option>
                            ...
                            {order.status.toLowerCase() !== "accept" &&
                              ...
                              order.deliveryStatus !== "cancelled" && (
                                <>
                                  <button
                                    onClick={() =>
                                      handleStatusUpdate(order.id, "Accept")
                                    }
                                  ...
                                  <button
                                    onClick={() =>
                                      handleStatusUpdate(order.id, "Reject")
                                    }
